...
import { createSiteService, getSitesService } from "../services/site.service";
import type { CreateSiteInput } from "../type";
...
export async function getSitesController(req: Request, res: Response) {
  try {
